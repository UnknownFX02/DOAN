...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<td> <details><summary><p style=\"color:red;\">MD5</p></summary><p>$file_md5</p></details></td>"; 
    echo "<td>$file_date</td>";
    echo "<td>$file_status</td>";
    echo "<td><a href=\"../viewmore.php?file_id=$file_id\" target='_blank' style='color:green'>View </a></td>";
