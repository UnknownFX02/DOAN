...
echo "<script>alert('file size is not proper');</script>";
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'], $folder.$notefile)) {
            $query = "INSERT INTO uploads(file_name, file_description, file_type, file_size, file_md5, file_uploader, file_uploaded_to, file) VALUES ('$file_title' , '$file_description' , '$fileext' , '$file_size' , '$file_md5' , '$file_uploader' , '$file_uploaded_to' , '$notefile')";
